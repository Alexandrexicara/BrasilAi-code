      ...
      <section id="precos" style={styles.pricing}>
        ...
        <div style={styles.priceGrid}>
          <div style={styles.priceCard}>
            ...
            <Link to="/register" style={styles.ctaOrange}>Contratar</Link>
          </div>
...
const styles = {
  ...
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 0', borderBottom: `3px solid ${C.orange}` },
  ...
  ctaOrange: { padding: '12px 24px', border: `2px solid ${C.green}`, color: C.green, borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold' },
  ...
  codeBlock: { marginTop: '24px', padding: '20px', background: '#111', color: '#e0e0e0', borderRadius: '8px', fontSize: '13px', whiteSpace: 'pre', border: `1px solid ${C.orange}40` },
  footer: { textAlign: 'center', padding: '40px 0', color: C.textMuted, fontSize: '14px', borderTop: `2px solid ${C.orange}60`, marginTop: '40px' },
};
